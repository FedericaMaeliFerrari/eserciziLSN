...
{
	//return 1.0;
	return exp(-pow((v-0.8),2.)/(2*0.8*0.8))+exp(-pow((v+0.8),2.)/(2*0.8*0.8));
}

double variationalWaveFunction_second(double v)
{
	//return 0;
	return -1./(0.8*0.8)*(exp(-pow((v-0.8),2.)/(2*0.8*0.8))+exp(-pow((v+0.8),2.)/(2*0.8*0.8)))+1./pow(0.8,4.)*(pow((v-0.8),2.)+pow((v+0.8),2.));
}
...
{
	ofstream out("probability_"+ to_string(temperature) +".dat");
